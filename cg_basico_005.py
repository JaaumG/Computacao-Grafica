...
class AplicativoReta:
    ...
    def desenhar_reta(self):
        ...
        x3_mundo, y3_mundo = 0, 5    # Ponto final no mundo
        ...
        x3_dispositivo = self.mapear_x(x3_mundo)
        y3_dispositivo = self.mapear_y(y3_mundo)
        ...
        self.canvas.create_line(x1_dispositivo, y1_dispositivo,
                                ...
                                fill="blue", width=2)
        self.canvas.create_line(x1_dispositivo, y1_dispositivo,
                                x3_dispositivo, y3_dispositivo,
                                fill="blue", width=2)
        self.canvas.create_line(x2_dispositivo, y2_dispositivo,
                                x3_dispositivo, y3_dispositivo,
                                fill="blue", width=2)
